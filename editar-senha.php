                    ...
                    <div class="col-8 px-3" id="profile-content">
                        ...
                        <form id="updateUser" onsubmit="sendUpdateSenha(event)">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" class="form-control" id="confirmSenhaNova" name="confirmSenhaNova" autocomplete="off" onkeyup="confirmaSenha(event, '#senhaNova')" placeholder="Repita sua nova senha" required>
                            </div>
